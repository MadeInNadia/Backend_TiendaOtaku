...
class ContactosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post contactos_url, params: { contacto: { email: @contacto.email, nombre: @contacto.nombre, pregunta: @contacto.pregunta } }, as: :json
    end
  ...
  test "should update contacto" do
    patch contacto_url(@contacto), params: { contacto: { email: @contacto.email, nombre: @contacto.nombre, pregunta: @contacto.pregunta } }, as: :json
    assert_response 200
  end
