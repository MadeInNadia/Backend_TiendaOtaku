...
class PerfilsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create perfil" do
    assert_difference('Perfil.count') do
      post perfils_url, params: { perfil: { comentarios: @perfil.comentarios, favoritos: @perfil.favoritos, intereses: @perfil.intereses, puntos: @perfil.puntos } }, as: :json
    end
  ...
  test "should update perfil" do
    patch perfil_url(@perfil), params: { perfil: { comentarios: @perfil.comentarios, favoritos: @perfil.favoritos, intereses: @perfil.intereses, puntos: @perfil.puntos } }, as: :json
    assert_response 200
  end
